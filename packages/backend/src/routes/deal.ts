...
dealRouter.post(
	...
	describeRoute({
		description: "Record an expense payment for a specific deal (expense - paying out money). Creates payment entry 6060-1010/1030. If accrual entry (7110-3310 for services or 1330-3310 for products) doesn't exist yet, creates it automatically",
		tags: ["Deals", "Payments", "Accounting"],
		parameters: [
			{
				name: "dealId",
