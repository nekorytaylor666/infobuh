...
- **Услуги (service)**: При создании генерируется АВР (Акт выполненных работ)
- **Товары (product)**: При создании генерируется накладная
